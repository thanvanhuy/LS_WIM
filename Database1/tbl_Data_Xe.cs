namespace Giatrican.Database1
{
    ...
    public partial class tbl_Data_Xe
    {
        ...
        public int? Taitrongdaukeo { get; set; }
            ...
            if (checktype)
            {
                switch (type)
                {
                    ...
                    case 2:
                        ...
                        this.TLtruc2 = this.Taitrongtruc2_1;
                        this.Quataitruc1 = Math.Max(0, (((double)(this.Taitrongtruc1_1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc2 = Math.Max(0, (((double)(this.Taitrongtruc2_1 - Declare.xe16tan) / Declare.xe16tan) * 100));
                        this.Quataitong = Math.Max(0, (((double)(this.TTLtruc - Declare.xe24tan) / Declare.xe24tan) * 100));
                    ...
                    case 3:
                        ...
                        this.Quataitruc1 = Math.Max(0, (((double)(this.Taitrongtruc1_1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc2 = Math.Max(0, (((double)(this.Taitrongtruc2_1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc3 = Math.Max(0, (((double)(this.Taitrongtruc3_1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitong = Math.Max(0, (((double)(this.TTLtruc - Declare.xe24tan) / Declare.xe24tan) * 100));
                    ...
                    case 4:
                        ...
                        this.TLtruc2 = this.Taitrongtruc2_1;
                        this.Quataitruc1 = Math.Max(0, (((double)(this.Taitrongtruc1_1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc2 = Math.Max(0, (((double)(this.Taitrongtruc2_1 - Declare.xe24tan) / Declare.xe24tan) * 100));
                    ...
                    case 6:
                        ...
                        this.Quataitong = Math.Max(0, (((double)(this.TTLtruc - Declare.xe34tan) / Declare.xe34tan) * 100));
                    ...
                    case 7:
                        ...
                        this.Quataitruc2 = Math.Max(0, (((double)(this.Taitrongtruc2_1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc3 = Math.Max(0, (((double)(this.Taitrongtruc3_1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitong = Math.Max(0, (((double)(this.TTLtruc - Declare.xe26tan) / Declare.xe26tan) * 100));
            ...
            else
            {
                switch (type)
                {
                    ...
                    case 2:
                        ...
                        this.Quataitruc1 = Math.Max(0, (((double)(this.Taitrongtruc1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc2 = Math.Max(0, (((double)(this.Taitrongtruc1 + this.Taitrongtruc2 - Declare.xe16tan) / Declare.xe16tan) * 100));
                        this.Quataitong = Math.Max(0, (((double)(this.TTLtruc - Declare.xe24tan) / Declare.xe24tan) * 100));
                        return;
                    case 3:
                        this.TLtruc1 = this.Taitrongtruc1;
                        ...
                        this.Quataitruc1 = Math.Max(0, (((double)(this.Taitrongtruc1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc2 = Math.Max(0, (((double)(this.Taitrongtruc2 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc3 = Math.Max(0, (((double)(this.Taitrongtruc3 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitong = Math.Max(0, (((double)(this.TTLtruc - Declare.xe24tan) / Declare.xe24tan) * 100));
                        return;
                    case 4:
                        this.TLtruc1 = this.Taitrongtruc1;
                        ...
                        this.Quataitruc1 = Math.Max(0, (((double)(this.Taitrongtruc1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc2 = Math.Max(0, (((double)(this.Taitrongtruc2 + this.Taitrongtruc3 + this.Taitrongtruc4 - Declare.xe21tan) / Declare.xe21tan) * 100));
                        this.Quataitong = Math.Max(0, (((double)(this.TTLtruc - Declare.xe30tan) / Declare.xe30tan) * 100));
                        return;
                    case 5:
                        this.TLtruc1 = this.Taitrongtruc1;
                    ...
                    case 6:
                        ...
                        this.Quataitruc1 = Math.Max(0, (((double)(this.Taitrongtruc1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc2 = Math.Max(0, (((double)(this.Taitrongtruc2 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc3 = Math.Max(0, (((double)(this.Taitrongtruc3 + this.Taitrongtruc4 + this.Taitrongtruc5 - Declare.xe21tan) / Declare.xe21tan) * 100));
                        this.Quataitong = Math.Max(0, (((double)(this.TTLtruc - Declare.xe34tan) / Declare.xe34tan) * 100));
                        return;
                    case 7:
                        this.TLtruc1 = this.Taitrongtruc1;
                    ...
                    case 9:
                        ...
                        this.Quataitruc3 = Math.Max(0, (((double)(this.Taitrongtruc4 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitong = Math.Max(0, (((double)(this.TTLtruc - Declare.xe34tan) / Declare.xe34tan) * 100));
                        return;
                    case 10:
                        this.TLtruc1 = this.Taitrongtruc1;
                        ...
                        this.Quataitruc1 = Math.Max(0, (((double)(this.Taitrongtruc1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc2 = Math.Max(0, (((double)(this.Taitrongtruc2 + this.Taitrongtruc3 - Declare.xe16tan) / Declare.xe16tan) * 100));
                        this.Quataitruc3 = Math.Max(0, (((double)(this.Taitrongtruc4 + this.Taitrongtruc5 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitong = Math.Max(0, (((double)(this.TTLtruc - Declare.xe42tan) / Declare.xe42tan) * 100));
                        return;
                    case 11:
                        this.TLtruc1 = this.Taitrongtruc1;
                        this.TLtruc2 = this.Taitrongtruc2;
                        ...
                        this.Quataitruc1 = Math.Max(0, (((double)(this.Taitrongtruc1 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc2 = Math.Max(0, (((double)(this.Taitrongtruc2 - Declare.xe10tan) / Declare.xe10tan) * 100));
                        this.Quataitruc3 = Math.Max(0, (((double)(this.Taitrongtruc3 + this.Taitrongtruc4 + this.Taitrongtruc5 - Declare.xe24tan) / Declare.xe24tan) * 100));
                        this.Quataitong = Math.Max(0, (((double)(this.TTLtruc - Declare.xe44tan) / Declare.xe44tan) * 100));
                        return;
                    case 12:
                        this.TLtruc1 = this.Taitrongtruc1;
                        this.TLtruc2 = this.Taitrongtruc2 + this.Taitrongtruc3;
